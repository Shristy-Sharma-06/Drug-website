...
function More2() {
  ...
  return (
    <>
      ...
      <div className='p-18 '>
        <img
          src="https://www.medipharmadrughouse.com/images/vitamins-banner.jpg"
          alt="Vitamins Banner"
          className="w-full 72-64 object-cover rounded-2xl"
        />
      </div>
      ...
      <div className="flex flex-col md:flex-row justify-between gap-8 px-6 md:px-16 py-10 bg-gradient-to-br from-white to-gray-100">
        ...
        <div className="md:w-2/3">
          <h1 className="text-3xl font-bold text-orange-500 mb-4">Vitamins</h1>
